...
# Question: Ask for an integer from user and diplay the two most significant digits (the two leftmost digits) and the number if it 
#           is less than 10  
...
#Short version
try: 
	print(f"The most two significant digits: {str(abs(int(input("Enter an integer: ").strip())))[:2]}")
